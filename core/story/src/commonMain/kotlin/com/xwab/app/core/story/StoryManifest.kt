 ...
 * `core:delivery`, whose resolver starts a background download whenever it misses.
 *
 * The list never leaves the module. StoryPort serves metadata and streams through one
 * implementation. Recording sources
