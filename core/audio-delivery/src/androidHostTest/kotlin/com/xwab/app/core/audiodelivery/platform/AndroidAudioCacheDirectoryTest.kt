...
import com.xwab.app.core.audiodelivery.cache.partialCacheFileName
...
class AndroidAudioCacheDirectoryTest {
    ...
    fun theStoreCachesPromotesAndSweepsOnDisk() = runBlocking {
        val cached = FILE_NAME
        write("long-gone-v1.mp3", bytes = 4)
        val store = CachingAudioFileStore(
            directory,
            TransportWritingBytes(root, bytes = 8),
            catalogKeeping(cached),
        )
