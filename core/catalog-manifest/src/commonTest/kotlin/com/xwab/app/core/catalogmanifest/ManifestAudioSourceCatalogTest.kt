...
/**
 * The port `core:audio-delivery` reads the manifest through.
 *
...
class ManifestAudioSourceCatalogTest {
    ...
    fun aTrackIsAnsweredWithItsCacheNameAndItsSource() {
        val source = assertNotNull(catalog.sourceFor("heavy-rain"))
    ...
    fun anUnknownTrackHasNoSource() {
        assertNull(catalog.sourceFor("no-such-track"))
    }
